...
PHP_INI_BEGIN()
	...
	STD_PHP_INI_ENTRY("xdebug.client_discovery_cookie", "",          PHP_INI_ALL, OnUpdateString, settings.debugger.client_discovery_cookie,   zend_xdebug_globals, xdebug_globals)
